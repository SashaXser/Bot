...
function setLikes(likesCount) {
  isMobile && (getButtons().children[0].querySelector(".button-renderer-text").innerText = likesCount);
}

function setDislikes(dislikesCount) {
  isMobile ? (mobileDislikes = dislikesCount) : getDislikeTextContainer()?.removeAttribute('is-empty');
